        ...
        if(user == null){
        	...
        	if(cookies!=null && cookies.length>0){
	  			  ...
	  			  if(cookieValue==null){
	  				  ...
	  				  request.getRequestDispatcher("/ting/index.html").forward(request, response);
		  	          return false;
	  			  }else{
  		    	...
  		    	request.getRequestDispatcher("/WEB-INF/jsp/login.jsp").forward(request, response);///WEB-INF/jsp/login.jsp
  	            return false;
  		    }
        }
        return true;   
